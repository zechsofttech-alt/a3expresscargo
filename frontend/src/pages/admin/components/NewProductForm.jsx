        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
              required
            />
          </div>
            ...
            {formData.additionalInfo.map((info, index) => (
              <div key={index} className="flex gap-2 mb-2">
                ...
                <button
                  ...
                  className="text-red-500 hover:text-red-700 transition-colors mt-1 font-medium text-sm"
                >
                  Remove
                </button>
              </div>
